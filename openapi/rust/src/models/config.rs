...
pub struct Config {
    ...
    #[serde(rename = "persistent_threads", skip_serializing_if = "Option::is_none")]
    pub persistent_threads: Option<bool>,
    /// Automatically commit worker changes after every turn.
    #[serde(rename = "ghost_commits", skip_serializing_if = "Option::is_none")]
    pub ghost_commits: Option<bool>,
    /// (experimental) Attach worker reasoning traces to messages sent to the orchestrator.
    #[serde(rename = "drift_manager", skip_serializing_if = "Option::is_none")]
    pub drift_manager: Option<bool>,
}
